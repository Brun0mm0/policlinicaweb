...
<section class="cid-slJ5IV7u3A" id="map2-a">
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-12 m-auto">
        <div class="align-wrap">
          <div class="icons-wrap">
            <div class="icon-wrap"> <span class="mbr-iconfont mobi-mbri-calendar mobi-mbri" style="color: rgb(15, 118, 153); fill: rgb(15, 118, 153);"></span>
              <div class="text-wrap">
          ...
          <div class="icons-wrap">
            <div class="icon-wrap"> <span class="mbr-iconfont icon54-v1-medical-bag"></span>
              <div class="text-wrap">
          ...
          <div class="icons-wrap">
            <div class="icon-wrap"> <span class="mbr-iconfont mbrib-pin"></span>
              <div class="text-wrap">
      ...
      <div class="col-lg-6 mx-auto mbr-form" data-form-type="formoid">
        ...
        <!--Formbuilder Form-->
        <?}else{?>
        <h3 class="icon-title mbr-bold mbr-fonts-style display-7">Gracias por comunicarse con nosotros,<BR>
          en breve nos contactaremos con Ud.</h3>
        <?}?>
      </div>
    </div>
  </div>
